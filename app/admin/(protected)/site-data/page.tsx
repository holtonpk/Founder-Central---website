...
const AnalyticsPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8 items-center pt-8 md:container px-4 ">
        <div className="md:col-span-4 md:w-[80%] flex flex-col  w-full">
          <div className="md:flex gap-4 items-end w-full grid grid-cols-2">
        ...
        <div className="grid md:grid-cols-6 gap-8 w-full  ">
          <Card className="h-80  rounded-md border border-border md:col-span-3 w-full ">
            ...
            <CardContent className="mt-2 relative w-full">
              <ScrollArea className="h-48  relative rounded-md  w-[80vw] md:w-[600px] ">
          ...
          <Card className="h-80 w-full rounded-md border border-border md:col-span-3">
            ...
            <CardContent className="mt-2">
              <ScrollArea className="h-48 w-[80vw] md:w-full rounded-md   md:col-span-2">
                {loading || !analyticsData ? (
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <Icons.spinner className="h-12 w-12 text-primary  ml-auto animate-spin " />
                  </div>
          ...
          <Card className="h-80  rounded-md border border-border md:col-span-2">
            <CardHeader className="border-b border-border">
              <CardTitle className="text-2xl font-semibold">
                Operating Systems
              </CardTitle>
